...
h q[59];
x psi[0];
cp(0.2047380201172801) psi[0],q[0];
cp(0.4094760402345602) psi[0],q[1];
cp(0.8189520804691204) psi[0],q[2];
cp(1.6379041609382408) psi[0],q[3];
cp(-3.0073769853031043) psi[0],q[4];
cp(0.2684313365733774) psi[0],q[5];
cp(0.5368626731467548) psi[0],q[6];
cp(1.0737253462935097) psi[0],q[7];
cp(2.1474506925870194) psi[0],q[8];
cp(-1.988283922005547) psi[0],q[9];
cp(2.306617463168492) psi[0],q[10];
cp(-1.669950380842602) psi[0],q[11];
cp(2.9432845454943823) psi[0],q[12];
cp(-0.39661621619082194) psi[0],q[13];
cp(-0.7932324323816439) psi[0],q[14];
cp(-1.5864648647632877) psi[0],q[15];
cp(3.1102555776530108) psi[0],q[16];
cp(-0.0626741518735651) psi[0],q[17];
cp(-0.1253483037471302) psi[0],q[18];
cp(-0.2506966074942604) psi[0],q[19];
cp(-0.5013932149885209) psi[0],q[20];
cp(-1.0027864299770417) psi[0],q[21];
cp(-2.0055728599540834) psi[0],q[22];
cp(2.27203958727142) psi[0],q[23];
cp(-1.7391061326367467) psi[0],q[24];
cp(2.8049730419060928) psi[0],q[25];
cp(-0.6732392233674006) psi[0],q[26];
cp(-1.3464784467348012) psi[0],q[27];
cp(-2.6929568934696024) psi[0],q[28];
cp(0.8972715202403814) psi[0],q[29];
cp(1.7945430404807627) psi[0],q[30];
swap q[29],q[30];
cp(-2.6940992262180607) psi[0],q[31];
swap q[28],q[31];
cp(0.8949868547434644) psi[0],q[32];
swap q[27],q[32];
cp(1.7899737094869288) psi[0],q[33];
swap q[26],q[33];
cp(-2.7032378882057286) psi[0],q[34];
swap q[25],q[34];
cp(0.8767095307681287) psi[0],q[35];
swap q[24],q[35];
cp(1.7534190615362575) psi[0],q[36];
swap q[23],q[36];
cp(-2.7763471841070713) psi[0],q[37];
swap q[22],q[37];
cp(0.7304909389654439) psi[0],q[38];
swap q[21],q[38];
cp(1.4609818779308879) psi[0],q[39];
swap q[20],q[39];
cp(2.9219637558617757) psi[0],q[40];
swap q[19],q[40];
cp(-0.43925779545603444) psi[0],q[41];
swap q[18],q[41];
cp(-0.8785155909120689) psi[0],q[42];
swap q[17],q[42];
cp(-1.7570311818241378) psi[0],q[43];
swap q[16],q[43];
cp(2.7691229435313107) psi[0],q[44];
swap q[15],q[44];
cp(-0.7449394201169645) psi[0],q[45];
swap q[14],q[45];
cp(-1.489878840233929) psi[0],q[46];
swap q[13],q[46];
cp(-2.979757680467858) psi[0],q[47];
swap q[12],q[47];
cp(0.3236699462438703) psi[0],q[48];
swap q[11],q[48];
cp(0.6473398924877406) psi[0],q[49];
swap q[10],q[49];
cp(1.2946797849754812) psi[0],q[50];
swap q[9],q[50];
cp(2.5893595699509624) psi[0],q[51];
swap q[8],q[51];
cp(-1.1044661672776617) psi[0],q[52];
swap q[7],q[52];
cp(-2.2089323345553233) psi[0],q[53];
swap q[6],q[53];
cp(1.8653206380689396) psi[0],q[54];
swap q[5],q[54];
