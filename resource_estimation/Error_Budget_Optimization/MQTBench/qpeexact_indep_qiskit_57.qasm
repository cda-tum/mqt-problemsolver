...
h q[55];
x psi[0];
cp(0.20473796326334434) psi[0],q[0];
cp(0.4094759265266887) psi[0],q[1];
cp(0.8189518530533774) psi[0],q[2];
cp(1.6379037061067547) psi[0],q[3];
cp(-3.0073778949660768) psi[0],q[4];
cp(0.26842951724743286) psi[0],q[5];
cp(0.5368590344948657) psi[0],q[6];
cp(1.0737180689897314) psi[0],q[7];
cp(2.147436137979463) psi[0],q[8];
cp(-1.9883130312206603) psi[0],q[9];
cp(2.3065592447382657) psi[0],q[10];
cp(-1.6700668177030553) psi[0],q[11];
cp(2.9430516717734756) psi[0],q[12];
cp(-0.39708196363263487) psi[0],q[13];
cp(-0.7941639272652697) psi[0],q[14];
cp(-1.5883278545305395) psi[0],q[15];
cp(3.1065295981185073) psi[0],q[16];
cp(-0.07012611094257179) psi[0],q[17];
cp(-0.14025222188514358) psi[0],q[18];
cp(-0.28050444377028716) psi[0],q[19];
cp(-0.5610088875405743) psi[0],q[20];
cp(-1.1220177750811486) psi[0],q[21];
cp(-2.2440355501622973) psi[0],q[22];
cp(1.795114206854992) psi[0],q[23];
cp(-2.6929568934696024) psi[0],q[24];
cp(0.8972715202403814) psi[0],q[25];
cp(1.7945430404807627) psi[0],q[26];
cp(-2.6940992262180607) psi[0],q[27];
cp(0.8949868547434644) psi[0],q[28];
swap q[27],q[28];
cp(1.7899737094869288) psi[0],q[29];
swap q[26],q[29];
cp(-2.7032378882057286) psi[0],q[30];
swap q[25],q[30];
cp(0.8767095307681287) psi[0],q[31];
swap q[24],q[31];
cp(1.7534190615362575) psi[0],q[32];
swap q[23],q[32];
cp(-2.7763471841070713) psi[0],q[33];
swap q[22],q[33];
cp(0.7304909389654439) psi[0],q[34];
swap q[21],q[34];
cp(1.4609818779308879) psi[0],q[35];
swap q[20],q[35];
cp(2.9219637558617757) psi[0],q[36];
swap q[19],q[36];
cp(-0.43925779545603444) psi[0],q[37];
swap q[18],q[37];
cp(-0.8785155909120689) psi[0],q[38];
swap q[17],q[38];
cp(-1.7570311818241378) psi[0],q[39];
swap q[16],q[39];
cp(2.7691229435313107) psi[0],q[40];
swap q[15],q[40];
cp(-0.7449394201169645) psi[0],q[41];
swap q[14],q[41];
cp(-1.489878840233929) psi[0],q[42];
swap q[13],q[42];
cp(-2.979757680467858) psi[0],q[43];
swap q[12],q[43];
cp(0.3236699462438703) psi[0],q[44];
swap q[11],q[44];
cp(0.6473398924877406) psi[0],q[45];
swap q[10],q[45];
cp(1.2946797849754812) psi[0],q[46];
swap q[9],q[46];
cp(2.5893595699509624) psi[0],q[47];
swap q[8],q[47];
cp(-1.1044661672776617) psi[0],q[48];
swap q[7],q[48];
cp(-2.2089323345553233) psi[0],q[49];
swap q[6],q[49];
cp(1.8653206380689396) psi[0],q[50];
swap q[5],q[50];
