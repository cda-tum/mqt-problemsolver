...
h q[62];
x psi[0];
cp(0.20473800904147033) psi[0],q[0];
cp(0.40947601808294065) psi[0],q[1];
cp(0.8189520361658813) psi[0],q[2];
cp(1.6379040723317626) psi[0],q[3];
cp(-3.0073771625160615) psi[0],q[4];
cp(0.26843098214746364) psi[0],q[5];
cp(0.5368619642949273) psi[0],q[6];
cp(1.0737239285898545) psi[0],q[7];
cp(2.147447857179709) psi[0],q[8];
cp(-1.9882895928201683) psi[0],q[9];
cp(2.3066061215392497) psi[0],q[10];
cp(-1.669973064101087) psi[0],q[11];
cp(2.943239178977412) psi[0],q[12];
cp(-0.39670694922476224) psi[0],q[13];
cp(-0.7934138984495245) psi[0],q[14];
cp(-1.586827796899049) psi[0],q[15];
cp(3.1095297133814883) psi[0],q[16];
cp(-0.06412588041660923) psi[0],q[17];
cp(-0.12825176083321846) psi[0],q[18];
cp(-0.2565035216664369) psi[0],q[19];
cp(-0.5130070433328738) psi[0],q[20];
cp(-1.0260140866657477) psi[0],q[21];
cp(-2.0520281733314953) psi[0],q[22];
cp(2.179128960516595) psi[0],q[23];
cp(-1.9249273861463958) psi[0],q[24];
cp(2.4333305348867946) psi[0],q[25];
cp(-1.416524237405997) psi[0],q[26];
cp(-2.833048474811994) psi[0],q[27];
cp(0.6170883575555981) psi[0],q[28];
cp(1.2341767151111962) psi[0],q[29];
cp(2.4683534302223924) psi[0],q[30];
cp(-1.3464784467348012) psi[0],q[31];
cp(-2.6929568934696024) psi[0],q[32];
swap q[30],q[32];
cp(0.8972715202403814) psi[0],q[33];
swap q[29],q[33];
cp(1.7945430404807627) psi[0],q[34];
swap q[28],q[34];
cp(-2.6940992262180607) psi[0],q[35];
swap q[27],q[35];
cp(0.8949868547434644) psi[0],q[36];
swap q[26],q[36];
cp(1.7899737094869288) psi[0],q[37];
swap q[25],q[37];
cp(-2.7032378882057286) psi[0],q[38];
swap q[24],q[38];
cp(0.8767095307681287) psi[0],q[39];
swap q[23],q[39];
cp(1.7534190615362575) psi[0],q[40];
swap q[22],q[40];
cp(-2.7763471841070713) psi[0],q[41];
swap q[21],q[41];
cp(0.7304909389654439) psi[0],q[42];
swap q[20],q[42];
cp(1.4609818779308879) psi[0],q[43];
swap q[19],q[43];
cp(2.9219637558617757) psi[0],q[44];
swap q[18],q[44];
cp(-0.43925779545603444) psi[0],q[45];
swap q[17],q[45];
cp(-0.8785155909120689) psi[0],q[46];
swap q[16],q[46];
cp(-1.7570311818241378) psi[0],q[47];
swap q[15],q[47];
cp(2.7691229435313107) psi[0],q[48];
swap q[14],q[48];
cp(-0.7449394201169645) psi[0],q[49];
swap q[13],q[49];
cp(-1.489878840233929) psi[0],q[50];
swap q[12],q[50];
cp(-2.979757680467858) psi[0],q[51];
swap q[11],q[51];
cp(0.3236699462438703) psi[0],q[52];
swap q[10],q[52];
cp(0.6473398924877406) psi[0],q[53];
swap q[9],q[53];
cp(1.2946797849754812) psi[0],q[54];
swap q[8],q[54];
cp(2.5893595699509624) psi[0],q[55];
swap q[7],q[55];
cp(-1.1044661672776617) psi[0],q[56];
swap q[6],q[56];
cp(-2.2089323345553233) psi[0],q[57];
swap q[5],q[57];
cp(1.8653206380689396) psi[0],q[58];
swap q[4],q[58];
